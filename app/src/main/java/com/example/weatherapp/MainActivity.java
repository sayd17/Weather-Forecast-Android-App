...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView search;
    TextView tempText , descText , humidityText, pressureText, windText, tempminText, tempmaxText;
    EditText textField;
       ...
       ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        ...
        call.enqueue(new Callback<Example>() {
            ...
            public void onResponse(Call<Example> call, Response<Example> response) {
                ...
                pressureText.setText("Pressure"+" "+response.body().getMain().getPressure()+" hPa");
                tempminText.setText("Minimum Temperature"+" "+response.body().getMain().getTemp_min()+" °C");
                tempmaxText.setText("Maximum Temperature"+" "+response.body().getMain().getTemp_max()+" °C");
